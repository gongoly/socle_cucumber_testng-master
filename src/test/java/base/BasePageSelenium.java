...
public class BasePageSelenium extends BaseTest {
	...
	public static String getBrowserName() {
	    ...
	    ExtentTestManager.getTest().log(LogStatus.INFO, "<b style=\"font-size: 110%\">" + StringEscapeUtils.escapeHtml("test") + "</b>", StringEscapeUtils.escapeHtml("La page est bien affichée"));
